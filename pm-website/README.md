...
```
cd existing_repo
git remote add origin https://gitlab.cc-asp.fraunhofer.de/programmable-money/pm-zkp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cc-asp.fraunhofer.de/programmable-money/pm-zkp/-/settings/integrations)
